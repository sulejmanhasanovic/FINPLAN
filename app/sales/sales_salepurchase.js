...
function getDataSalesPurchases(){
    $.ajax({
        ...
        success: function (results) {
            ...
            <td><a class='pointer' id='salepurchase_detail"+i+"' onclick='getDataSalePurchase("+salespurchase[i].id+", "+i+")'><i class='material-icons btnblue' data-lang-content='false' data-toggle='tooltip' lang='en' data-placement='top' title='' data-original-title='Edit'>edit</i></a></td>\
            <td>"+name+"</td>\
...
function getDataSalePurchase(id, i){
    ...
    if(id!=0){
        var thisClosest = $("#salepurchase_detail"+i).closest('tr');
