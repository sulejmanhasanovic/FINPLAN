...
function showData(results) {
    ...
    for(var j=0; j<bothCurr.length; j++){
        ...
        <div class='row'> \
         ...
         <div class='col-md-6'>\
         <input id='S_"+bothCurr[j]+"' type='text' class='form-control' size='50' autocomplete='off' value='"+s+"'/> \
         </div> \
         </div> \
         <div class='row'> \
         <div class='col-md-6'> \
         ...
         <div class='col-md-6'>\
         <input id='T_"+bothCurr[j]+"' type='text' class='form-control' size='50' autocomplete='off' value='"+t+"'/> \
         </div> \
         </div> \
         </td><td style='width:5px'></td>";

        cols.push({name:'A_'+bothCurr[j], editable:true, map: 'A_'+bothCurr[j], text:currencyName+" - Drawdown (Million)"});
    }
