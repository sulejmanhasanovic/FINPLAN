...
function showData(results) {
    ...
    for(var j=0; j<bothCurr.length; j++){
        ...
        <div class='row'> \
         ...
         <div class='col-md-6'>\
         <input id='ER_"+bothCurr[j]+"' type='text' class='form-control' size='50' autocomplete='off' value='"+er+"'/> \
         </div> \
         </div> \
         <div class='row'> \
         <div class='col-md-6'> \
         ...
         <div class='col-md-6'>\
         <input id='BT_"+bothCurr[j]+"' type='text' class='form-control' size='50' autocomplete='off' value='"+bt+"'/> \
         </div> \
         </div> \
         </td><td style='width:5px'></td>";

        cols.push({name:'B_'+bothCurr[j], editable:true, map: 'B_'+bothCurr[j], text:currencyName+" - Issued (Million)"});
    }
