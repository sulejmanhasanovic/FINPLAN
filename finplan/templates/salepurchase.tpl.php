...
function autopurchase(frm,start,end,box,text_caption)
{
...
function autounit()
{
 var shortcut = document.salepurchase
...
<h3><?php echo $salepurchase_1;?></h3>
A value entered for one year will also be applicable for subsequent years, until a new value is entered for a future year.
<table>
  <tr>
    <th><strong><?php echo $salepurchase_2;?></strong></th>

    <th><?php echo $salepurchase_4;?></th>
    <th><?php echo $salepurchase_5;?></th>
  </tr>
  <?php
  ...
  <tr>
    ...
    <td><span id="sprytextfield4"><?php echo $row['ClientName']?></span></td>
    <td><a href="?a=e&id=<?php echo $row['id']?>"><?php echo $salepurchase_6;?></a> &nbsp;/ <a href="?a=d&id=<?php echo $row['id']?>" onclick="return confirm('Are you sure you want to delete?');"><?php echo $del_opt;?></a> </td>
  </tr>
  <?php
								}
							}else{
...
<tr>
  <td><a href="salepurchase.php?e=a"><?php echo $salepurchase_7;?></a> </td>
</tr>
<?php if($_REQUEST['a']=='e' or $_REQUEST['e']=='a'){
  ?>
<form method="post" name="salepurchase" action="salepurchaseSave.php">
  <table width="650" align="center" border="0" cellpadding="2" cellspacing="0" bgcolor="white">
    <tr valign="top">
      <td><table width="100%" border="3" cellpadding="4" cellspacing="0">
          <tr>
            <th colspan="2" scope="col"><div align="center"></div></th>
          </tr>
          <tr>
            <td ><div align="right">
             <?php echo $salepurchase_8;?></td>
            <td ><div align="left">
...
?>
          ...
          <tr>
            <td ><div align="right">
              <?php echo $salepurchase_12;?></td>
            <td ><div align="left">
              <span id="sprytextfield1">
              <input type="text" size="50" name="data[ClientName]" id="clientNameId" value="<?php echo $spData['ClientName'];?>" onClick="checkInvalidChars()">
              <span class="textfieldRequiredMsg">Required</span></span> </td>
          </tr>
          <tr>
            <td ><div align="right">
              <?php echo $salepurchase_13;?></td>
            <td ><div align="left">
...
?>
          <tr>
            <td ><div align="right">
              <?php echo $salepurchase_14;?></td>
            <td >
              <div id="quantity_yr">
              <INPUT TYPE="Radio" NAME="data[Amount]" id="radio_yr" value="YR" <?php echo $spData['Amount']=='YR' || !$spData['Amount'] ?'checked="checked"':'' ?> ONCLICK="autopurchase(this.form,<?php echo $ahData['startYear'];?>,<?php echo $ahData['endYear'];?>,'YR','')" >
              <?php echo $salepurchase_16;?>&nbsp;
              <INPUT TYPE="Radio" NAME="data[Amount]" id="radio_fd" value="FD" <?php echo $spData['Amount']=='FD'?'checked="checked"':'' ?> ONCLICK="autopurchase(this.form,<?php echo $ahData['startYear'];?>,<?php echo $ahData['endYear'];?>,'FD','')"  >
              <?php echo $salepurchase_15;?>&nbsp;
        ...
        $sunitdata = array_key_exists($spData['Name'], $sunitArray) ? $sunitArray[$spData['Name']] : 'Per kWh';
			  ?>
			  <input  type="text" size="15" name="data[sunit]" id="sunit" value="<?php echo $sunitdata;?>" disabled>
    ...
    ?>
			...
			ONCLICK="autopurchase(this.form,<?php echo $ahData['startYear'];?>,<?php echo $ahData['endYear'];?>,'CP','<?php echo $salepurchase_20.' ('.$tradeCurrency.' '.$sunitdata.')'; ?>')" >
			</td><td ><div align="left">
              <?php echo $salepurchase_20;?><a style="text-decoration: none" title="Press 'Save' to Update Units">*</a></td></tr>
          <tr>
            <td ><div align="right">
              <INPUT TYPE="Radio" NAME="data[Price]" id="Price" value="YC" <?php echo $spData['Price']=='YC'?'checked="checked"':'' ?>
			  ONCLICK="autopurchase(this.form,<?php echo $ahData['startYear'];?>,<?php echo $ahData['endYear'];?>,'YC','<?php echo $salepurchase_18; ?>')">
			  </td>
			<td ><div align="left">
              <?php echo $salepurchase_18;?>&nbsp;
			 </td>
			</tr>
			<tr>
            <td ><div align="right">
              <INPUT TYPE="Radio" NAME="data[Price]" id="Price" value="SC" <?php echo $spData['Price']=='SC' || !$spData['Price'] ?'checked="checked"':'' ?>
			  ONCLICK="autopurchase(this.form,<?php echo $ahData['startYear'];?>,<?php echo $ahData['endYear'];?>,'SC','<?php echo $salepurchase_19; ?> (%)')" ></td>
            <td ><div align="left">  <?php echo $salepurchase_19;?>&nbsp;
			 <span id="sprytextfield3">
              <input  type="text" size="5" name="data[PriceFixed]" id="PriceFixed" value="<?php echo $spData['PriceFixed'] ? $spData['PriceFixed'] : 0;?>" <?php echo $steadydis;?>>(%)
    ...
    <tr>
      <td class="bodyText">&nbsp;
        <table width="100%" border="1"  cellspacing="0" cellpadding="0">
          <tr>
            <th ><?php echo $salepurchase_22;?></th>
            <th ><?php echo $salepurchase_23;?></th>
            <th >
