...
<body>
	...
	<div id="header-content">
		...
		<h2 id="slogan">A Model for Financial Analysis of Electric Sector Expansion Plans</h2>
...
<div id="content-wrap"><div id="content">
	...
	<a class="menuitem submenuheader" href="" >Menu</a>
	<div class="submenu">
		<ul class="sidemenu">

				<li><a href="begin.php">Open/Create Case Study</a></li>
				<li><a href="copy.php">Copy Case Study</a> </li>
				<li><a href="delete.php">Delete Case Study</a></li>
				<li><a href="backup.php">Backup Case Study</a> </li>
				<li><a href="restore.php">Restore Case Study</a> </li>
