...
<h3>Purchase by Currency (Million)</h3>
<table>
  <tr>
...
$chkData = $bad->getByField($_REQUEST['cid'],'TradeCurrency');
...
?>
    <td valign="top"><table border="1" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <td class="number"><?php echo round($row[$eval],$RoundPlace);?></td>
		</tr>
        <?php			}
