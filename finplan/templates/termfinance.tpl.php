...
?>
<h3>Terms of Financing: Export Credit <?php echo $ec_version;?></h3>
<table>
  <tr>
...
if(isset($_REQUEST['id'])){
  ...
  <form method="post" action="termfinanceSave.php">
    <table width="600" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <th ><?php echo $terfin_1 ;?></th>
        <th><?php echo $cpData['name'];?>
          <INPUT TYPE="hidden" NAME="data[Name]" value="<?php echo $_REQUEST['fs'];?>"> <!-- E1 -->
      ...
      <!-- Term -->
        ...
        <td ><span id="sprytextfield1">
          <INPUT TYPE="text" NAME="data[MaturityTime]" value="<?php echo $ctData['MaturityTime'];?>">(Years)
      ...
      <!-- Repayment Option -->
      <tr>
        <td ><div align="right" ><?php echo $terfin_6 ;?>  </td>
        <td >
          <input type="radio" name="data[RepaymentOption]" id="RepaymentOption" value="UI"  <?php echo $ctData['RepaymentOption']=='UI'?'checked="checked"':'' ?> >
          <?php echo $terfin_8 ;?>
          <input type="radio" name="data[RepaymentOption]" id="RepaymentOption" value="ST" <?php echo $ctData['RepaymentOption']=='ST'?'checked="checked"':'' ?> >
          <?php echo $terfin_7 ;?> </td>
      </tr>

      <?php
      if($ctData['InterestOption']=='C'){
          $RateDis = '';
          $SprdDis = 'disabled';
        }else{
          $RateDis = 'disabled';
	...
	<tr>
	  ...
	  <INPUT TYPE="text" id="PDRate" NAME="data[PDRate]" value="<?php echo $ctData['PDRate'];?>"<?php echo $pdDis;?>> %
	  <span class="textfieldRequiredMsg">Required</span>
	    <span class="textfieldInvalidFormatMsg">Invalid format.</span>
		<span class="textfieldMinValueMsg">Min Value:0 </span></td>
    </tr>
		<?php if($ctData['IDCOption']=='Y'){
			$IdcDis = '';
		}else{
			$IdcDis = 'disabled';
		}?>
	 <tr>
      <th ><div align="right" ><?php echo $terfin_26 ;?>  </th>
      <th > <input type="radio" name="data[IDCOption]" id="IDCOption" value="Y" <?php echo $ctData['IDCOption']=='Y'?'checked="checked"':'' ?>  ONCLICK="autoIDC(this.form,'Y')">
        <?php echo $terfin_27 ;?>
        <input type="radio" name="data[IDCOption]" id="IDCOption" value="N" <?php echo $ctData['IDCOption']=='N'?'checked="checked"':'' ?> ONCLICK="autoIDC(this.form,'N')"	>
        <?php echo $terfin_28 ;?> </th>
   </tr>
    <tr >
      <td ><div align="right" ><?php echo $terfin_30 ;?></td>
      <td><span id="sprytextfield7">
        <INPUT TYPE="text" NAME="data[IDCLoan]" id="data[IDCLoan]" value="<?php echo $ctData['IDCLoan'];?>" <?php echo $IdcDis;?>> % of IDC
		<span class="textfieldRequiredMsg">Required</span>
	    <span class="textfieldInvalidFormatMsg">Invalid format.</span>
		<span class="textfieldMinValueMsg">Min Value:0 </span></td>
    </tr>
	 <tr >
      <td ><div align="right" ><?php echo $terfin_31 ;?></td>
      <td><span id="sprytextfield8">
        <INPUT TYPE="text" NAME="data[IDCTerm]" id="data[IDCTerm]" value="<?php echo $ctData['IDCTerm'];?>" <?php echo $IdcDis;?>>(Years)
		<span class="textfieldRequiredMsg">Required</span>
	    <span class="textfieldInvalidFormatMsg">Invalid format.</span>
		<span class="textfieldMinValueMsg">Min Value:0 </span></td>
    </tr>
	 <tr >
      <td ><div align="right" ><?php echo $terfin_32 ;?></td>
      <td><span id="sprytextfield9">
        <INPUT TYPE="text" NAME="data[IDCRate]" id="data[IDCRate]" value="<?php echo $ctData['IDCRate'];?>" <?php echo $IdcDis;?>> %
		<span class="textfieldRequiredMsg">Required</span>
	    <span class="textfieldInvalidFormatMsg">Invalid format.</span>
		<span class="textfieldMinValueMsg">Min Value:0 </span></td>
    </tr>
   <tr>
      <td ><div align="right" ><?php echo $terfin_33 ;?>  </td>
      <td >
        <input type="radio" name="data[IDCRepayment]" id="IDCRepayment" value="ST" required  <?php echo $ctData['IDCRepayment']=='ST'?'checked="checked"':'' ?> >
        <?php echo $terfin_34 ;?>         
        <input type="radio" name="data[IDCRepayment]" id="IDCRepayment" value="UI"  <?php echo $ctData['IDCRepayment']=='UI'?'checked="checked"':'' ?> >
        <?php echo $terfin_35 ;?>
      </td>
   </tr>
	  </td>
...
<script type="text/javascript">
	...
	var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield7", "real", {isRequired:true, useCharacterMasking:true, validateOn:["change"], hint:"0.0",maxValue:100});
	var sprytextfield8 = new Spry.Widget.ValidationTextField("sprytextfield8", "real", {isRequired:true, useCharacterMasking:true, validateOn:["change"], hint:"0.0",maxValue:100});
	var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "real", {isRequired:true, useCharacterMasking:true, validateOn:["change"], hint:"0.0",maxValue:100});
</script>
