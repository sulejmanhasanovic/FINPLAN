...
<h3>Total O&M Cost For All Plants (Million)</h3>
...
?>
	  <td valign="top"><table border="1" width="250" cellpadding="0" cellspacing="0">
        <tr>
          <th colspan=2>Total O&M Cost in Local Currency</th>
        </tr>
        <tr>
